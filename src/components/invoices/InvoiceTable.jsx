...
const COLORS = {
    calendarDayActive: '#F48722', // Orange
    primary: '#0D47A1', // Blue for active row/links
    text: '#141414',
    border: '#E0E0E0',
    background: '#FFFFFF',
    dark: '#141414',
    searchContainerBg: '#F5F6FA' // Light background for the search input area
};


// 🌟 KEY CHANGE: Accept onSearchChange prop
                        ...
                        <tr style={{ background: '#E6EFFF', borderBottom: '1px solid #D0DFFF' }}>
                            <td colSpan="9" style={{ padding: '20px' }}>
                                <div style={{ 
                                    ...
                                    <h4 style={{ margin: '0 0 5px 0', fontSize: '14px', color: COLORS.text }}>Remark:</h4>
                                    <p style={{ margin: 0, fontSize: '13px', color: '#555555' }}>
                                        {invoice.remark}
                                    </p>
                                </div>
        ...
        <>
                ...
                <div style={{ 
                    ...
                    <div style={{ display: 'flex', gap: '4px' }}>
                        {weekDays.map((dayObj) => {
                            ...
                            // Split-color style for the active day
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Day Number - Apply split background if selected */}
                                    <span style={{ 
                                        width: '24px', 
                                        height: '24px', 
                                        borderRadius: '50%',
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', marginBottom: '20px', gap: '10px' }}>
                ...
                <div style={{ 
                    ...
                    padding: '8px 12px',
                    borderRadius: '6px',
                    backgroundColor: COLORS.searchContainerBg, // Light gray background
                    border: `1px solid ${COLORS.border}`,
                    ...
                    />
                    {/* Display the count next to the search box */}
                    <span style={{ 
                        fontSize: '12px', 
                        ...
                        padding: '2px 8px',
                        borderRadius: '4px',
                        backgroundColor: '#E0EFFF' // Light blue count background
                    }}>
            ...
            {/* 🧾 Table (Scrollable) */}
            <div style={{ overflowX: 'auto', width: '100%' }}>
                <table style={{ width: '100%', minWidth: '800px', borderCollapse: 'collapse', background: COLORS.background, borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
                    {renderHeader()}
                    {renderRows()}
                </table>
            </div>
