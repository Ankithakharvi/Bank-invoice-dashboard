...
//                     flexShrink: 0
//                 }}>
//                     <div style={{ fontSize: '11px', fontWeight: 600, color: '#555', marginBottom: '4px' }}>October 2025</div>
//                     <div style={{ display: 'flex', gap: '4px' }}>
//                         {['13','14','15','16','17','18','19'].map((day, index) => {
//                             const dayNames = ['S','M','T','W','T','F','S'];
//                             const activeDay = '17';
//                             return (
//                                 <div className="calendar-day" key={day} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', fontWeight: day === activeDay ? 700 : 500, color: day === activeDay ? '#F48722' : '#555' }}>
//                                     <span className="day-name" style={{ fontSize: '8px', marginBottom: '2px', color: '#555' }}>{dayNames[index]}</span>
//                                     <span style={{ 
//                                         width: '18px', 
//                                         height: '18px', 
//                                         borderRadius: '50%',
...
//                                         backgroundColor: day === activeDay ? '#FFF7F0' : 'transparent',
//                                         border: day === activeDay ? '1px solid #F48722' : 'none',
//                                         fontSize: '10px'
//                                     }}>{day}</span>
//                                 </div>
//                             );
