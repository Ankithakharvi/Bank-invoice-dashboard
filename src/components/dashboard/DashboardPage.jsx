...
// }
import React, { useState } from 'react';
// 1. Importing the JSON data - This is the single source of truth for all dynamic values.
import data from "../../data/dashboardData.json"; 
import MetricCard from "./MetricCard";
import ChartCard from "./ChartCard";
import DueByAgeSummary from "./DueByAgeSummary";
...
// 2. Define a static mapping for PRESENTATIONAL elements (icons and colors)
// The data values (total, amount) are NOT hardcoded here.
